...
void change_screen_to_demo(FloraWidget *widget, FloraApplicationState *state) {
    (void) widget;
    FloraScreen *demo = get_flora_screen(state->current_window, "demo");
    if (!demo) {
...
int main(const int argc, char **argv) {
    ...
    FloraScreen *base = init_flora_screen(state, window, "base", base_create_screen, deinit_screen);
    FloraScreen *demo = init_flora_screen(state, window, "demo", demo_create_screen, deinit_screen);
    if (!base || !demo) {
